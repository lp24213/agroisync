...
const collections = [
  ...
  },
  {
    ...
    color: '#9945FF',
    description: 'Solana-based farming collectibles',
  },
  {
    id: 3,
    name: 'Crypto Crops',
    ...
    color: '#FF6B6B',
    description: 'Unique crop-themed digital art',
  },
];
...
const nfts = [
  {
    ...
    attributes: [
      ...
      { trait_type: 'Crop Type', value: 'Wheat', rarity: 25 },
      { trait_type: 'Tech Level', value: 'Advanced', rarity: 10 },
      { trait_type: 'Season', value: 'Summer', rarity: 20 },
      { trait_type: 'Rarity', value: 'Rare', rarity: 8 },
    ],
    color: '#22C55E',
    description: 'A revolutionary agricultural technology pioneer NFT',
  },
  {
    id: 2,
      ...
      <div className='bg-agro-darker/90 backdrop-blur-md rounded-lg overflow-hidden'>
        <div className='relative'>
          ...
          <div className='absolute top-3 left-3 px-2 py-1 rounded-full bg-agro-darker/80 backdrop-blur-sm text-xs text-white flex items-center'>
            <div className='w-3 h-3 rounded-full mr-1' style={{ backgroundColor: nft.color }}></div>
            {nft.collection}
          </div>
...
export default function NFTMarketplacePage() {
  ...
  useEffect(() => {
    ...
    if (selectedCollections.length > 0) {
      filtered = filtered.filter(nft => selectedCollections.includes(nft.collection));
    }
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10'>
        ...
        >
          <div className='flex justify-between items-center mb-6'>
            ...
            <button className='text-sm text-agro-blue hover:underline'>View All Collections</button>
          </div>
            ...
            <div className='lg:w-1/4'>
              <div className='cyberpunk-border p-0.5 rounded-lg overflow-hidden sticky top-4'>
                <div className='bg-agro-darker/90 backdrop-blur-md p-5 rounded-lg'>
                  ...
                  <div
                    className={`space-y-6 ${showFilters || window.innerWidth >= 1024 ? 'block' : 'hidden'}`}
                  >
                    {/* Search */}
                    <div>
                    ...
                    <div>
                      ...
                      <div className='flex items-center space-x-2 mb-2'>
                        <input
                          ...
                          value={priceRange[0]}
                          onChange={e =>
                            handlePriceRangeChange(parseFloat(e.target.value), priceRange[1])
                          }
                        ...
                        <input
                          ...
                          value={priceRange[1]}
                          onChange={e =>
                            handlePriceRangeChange(priceRange[0], parseFloat(e.target.value))
                          }
                          className='w-full bg-agro-dark/50 border border-gray-700 rounded-lg p-2 text-white focus:outline-none focus:ring-2 focus:ring-agro-blue transition-colors'
                        />
                      </div>
