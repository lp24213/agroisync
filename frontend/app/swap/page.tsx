                ...
                {fromAmount && parseFloat(fromAmount) > 0 && (
                  <div className='bg-agro-dark/30 p-4 rounded-lg mb-6'>
                    ...
                    <div className='flex justify-between items-center mb-2'>
                      ...
                      <span
                        className={`text-sm ${parseFloat(priceImpact) > 3 ? 'text-yellow-400' : 'text-agro-green'}`}
                      >
                        {priceImpact}%
                      </span>
                    </div>
                ...
                {fromAmount && parseFloat(fromAmount) > 0 && parseFloat(priceImpact) > 3 && (
                  <div className='flex items-start space-x-3 p-3 bg-yellow-500/10 rounded-lg mb-6'>
                    ...
                    <p className='text-sm text-yellow-400'>
                      The price impact is relatively high. You might receive significantly less
              ...
              <div className='bg-agro-darker/90 backdrop-blur-md p-6 rounded-lg'>
                ...
                <div className='space-y-4'>
                  <div className='bg-agro-dark/30 p-3 rounded-lg'>
                    ...
                    <div className='flex justify-between items-center'>
                      <span className='text-sm text-gray-400'>
                        2.5 {tokens[0].symbol} for 583.25 {tokens[1].symbol}
                      </span>
                      <span className='text-xs px-2 py-0.5 rounded bg-agro-green/20 text-agro-green'>
                        Completed
                      </span>
                    </div>
                  </div>
                  ...
                  <div className='bg-agro-dark/30 p-3 rounded-lg'>
                    ...
                    <div className='flex justify-between items-center'>
                      <span className='text-sm text-gray-400'>
                        500 {tokens[2].symbol} for 4.15 {tokens[0].symbol}
                      </span>
                      <span className='text-xs px-2 py-0.5 rounded bg-agro-green/20 text-agro-green'>
                        Completed
                      </span>
                  ...
                  <div className='bg-agro-dark/30 p-3 rounded-lg'>
                    ...
                    <div className='flex justify-between items-center'>
                      <span className='text-sm text-gray-400'>
                        25 {tokens[3].symbol} for 9,125,000 {tokens[4].symbol}
                      </span>
                      <span className='text-xs px-2 py-0.5 rounded bg-agro-green/20 text-agro-green'>
                        Completed
                      </span>
                ...
                <ul className='space-y-3'>
                  <li className='flex items-start space-x-2'>
                    ...
                    <p className='text-sm text-gray-300'>
                      Use slippage tolerance to control price impact during high volatility.
                    </p>
                  </li>
                  <li className='flex items-start space-x-2'>
                    <div className='w-1.5 h-1.5 rounded-full bg-agro-blue mt-1.5' />
                    <p className='text-sm text-gray-300'>
                      Swapping large amounts may result in higher price impact.
                    </p>
                  </li>
                  <li className='flex items-start space-x-2'>
                    <div className='w-1.5 h-1.5 rounded-full bg-agro-blue mt-1.5' />
                    <p className='text-sm text-gray-300'>
                      Our router automatically finds the best price across multiple liquidity
                      sources.
                    </p>
                  </li>
                </ul>
