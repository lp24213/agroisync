...
const priceData = [
  ...
  { time: '20:00', price: 0.15, volume: 1420000 },
];
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className='card'>
      ...
      <div className='space-y-3'>
        <div className='grid grid-cols-2 gap-3'>
          <div className='p-3 bg-white/5 rounded-lg'>
            ...
            <p className='text-sm font-medium text-white'>${formatNumber(marketData.marketCap)}</p>
          </div>
          ...
          <div className='p-3 bg-white/5 rounded-lg'>
            ...
            <p className='text-sm font-medium text-white'>${formatNumber(marketData.volume24h)}</p>
          </div>
        </div>
        ...
        <div className='grid grid-cols-2 gap-3'>
          ...
          <div className='p-3 bg-white/5 rounded-lg'>
            ...
            <p className='text-sm font-medium text-white'>{formatNumber(marketData.totalSupply)}</p>
          </div>
        </div>
      </div>
      ...
      <div className='mt-4 flex space-x-2'>
        <button className='flex-1 btn-primary text-sm py-2'>Buy AGROTM</button>
        <button className='flex-1 btn-outline text-sm py-2'>Trade</button>
      </div>
    </motion.div>
  );
}
