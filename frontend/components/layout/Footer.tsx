...
export function Footer() {
  return (
    <footer className="bg-[#000000] border-t border-[#00bfff]/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              />
              <span className="hidden text-2xl font-bold text-[#00bfff] font-orbitron ml-2">AGROTM</span>
            </div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-[#cccccc] hover:text-[#00bfff] transition-colors">
