...
export function StakingForm({ onStake, onCancel, userBalance = 0, isLoading = false }: StakingFormProps) {
          ...
          <div className="p-4 bg-white/5 rounded-lg border border-white/10">
            ...
            <div className="grid grid-cols-2 gap-4 text-xs">
              <div>
                ...
                <span className="text-white ml-1">{formatNumber(selectedPool.minStake)} AGROTM</span>
              </div>
              <div>
                <span className="text-gray-400">Max Stake:</span>
                <span className="text-white ml-1">{formatNumber(selectedPool.maxStake)} AGROTM</span>
              </div>
              <div>
          ...
          <div className="p-3 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
            <div className="flex items-start">
              ...
              <div className="text-xs text-yellow-300">
                ...
                <p>Your tokens will be locked for {selectedPool.lockPeriod} days. You cannot withdraw or transfer them during this period.</p>
              </div>
            </div>
          </div>
        )}
