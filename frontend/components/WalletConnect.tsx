        ...
        <div className='grid grid-cols-1 gap-4'>
          ...
          <div className='p-4 bg-white/5 border border-white/10 rounded-lg'>
            <div className='flex items-center justify-between mb-3'>
              ...
              {solanaConnected && <CheckCircle className='w-5 h-5 text-green-400' />}
            </div>
          ...
          <div className='p-4 bg-white/5 border border-white/10 rounded-lg'>
            <div className='flex items-center justify-between mb-3'>
              ...
              {ethConnected && <CheckCircle className='w-5 h-5 text-green-400' />}
            </div>
            ...
            {ethConnected ? (
              ...
              <button onClick={connectEth} className='w-full btn-primary'>
                Connect MetaMask
              </button>
            )}
          </div>
