...
const stats = [
  ...
  { label: 'Total Farms', value: '156', change: '+5.2%', icon: Farm },
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center">
          ...
          >
            ...
            <span className="text-green-400 font-medium">Revolutionary DeFi Agriculture Platform</span>
          </motion.div>
          ...
          >
            Experience the next generation of decentralized finance. Farm, stake, and earn
            with the most advanced agricultural DeFi platform on Solana.
          </motion.p>
