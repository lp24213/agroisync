...
const features = [
  {
    ...
    description: 'Our platform focuses on supporting sustainable farming practices through DeFi protocols.',
    icon: Leaf,
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="card hover:scale-105 transition-all duration-300 h-full">
                  {/* Icon */}
                  <div className={`flex items-center justify-center w-12 h-12 rounded-lg bg-gradient-to-r ${feature.color} mb-4 group-hover:scale-110 transition-transform duration-300`}>
        ...
        >
          <div className="bg-gradient-to-r from-primary-500/10 to-accent-500/10 border border-primary-500/20 rounded-2xl p-8">
            ...
            <p className="text-gray-300 max-w-4xl mx-auto leading-relaxed">
              To democratize access to sustainable agriculture financing through blockchain technology, 
              creating a more equitable and environmentally conscious financial ecosystem. We believe 
              that by connecting traditional farming with modern DeFi protocols, we can build a 
