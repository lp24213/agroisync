  ...
  const features = [
    {
      ...
      description: 'IoT e automação para máxima eficiência'
    },
    {
      icon: <Zap className="w-5 h-5" />,
      title: 'Tecnologia Avançada',
      description: 'Sensores e IA para otimização de cultivos'
    },
    {
      icon: <Target className="w-5 h-5" />,
      title: 'Precisão Total',
      description: 'Monitoramento detalhado de cada hectare'
    },
    {
      icon: <TrendingUp className="w-5 h-5" />,
      title: 'Resultados Superiores',
      description: 'Aumento significativo na produtividade'
    }
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-orbitron font-bold text-[#00bfff] mb-6">
              Smart <span className="text-[#00bfff]">Farm</span>
            </h2>
            
            <p className="text-lg text-[#00bfff] mb-8 max-w-2xl mx-auto lg:mx-0">
              Tecnologia agrícola inteligente com IoT, automação avançada e IA para maximizar a produtividade e sustentabilidade do agronegócio.
            </p>
          ...
          >
            <div className="relative h-80 lg:h-96 rounded-2xl overflow-hidden border border-[#00bfff]/20 shadow-neon-blue">
              <Image
                ...
                alt="Smart Farm - Tecnologia Agrícola Inteligente"
                fill
