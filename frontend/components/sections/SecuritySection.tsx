  ...
  const features = [
    {
      ...
      description: 'Firewall blockchain de última geração'
    },
    {
      icon: <Lock className="w-5 h-5" />,
      title: 'Criptografia Total',
      description: 'Segurança militar para todos os dados'
    },
    {
    ...
    },
    {
      ...
      description: 'Ação imediata contra vulnerabilidades'
    }
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-orbitron font-bold text-[#00bfff] mb-6">
              Segurança <span className="text-[#00bfff]">Avançada</span>
            </h2>
            
            <p className="text-lg text-[#00bfff] mb-8 max-w-2xl mx-auto lg:mx-0">
              Protocolos de segurança blockchain de última geração para proteção total de ativos agrícolas com criptografia militar e monitoramento contínuo.
            </p>
          ...
          >
            <div className="relative h-80 lg:h-96 rounded-2xl overflow-hidden border border-[#00bfff]/20 shadow-neon-blue">
              <Image
                ...
                alt="Segurança Avançada - Proteção Blockchain Militar"
                fill
