...
const features = [
  {
    ...
    description: 'Multi-layer security with smart contract audits, insurance coverage, and real-time monitoring.',
    icon: Shield,
    color: 'from-red-500 to-pink-500',
  },
  {
    name: 'High Performance',
    description: 'Lightning-fast transactions with sub-second finality powered by Solana blockchain.',
    icon: Zap,
  ...
  },
  {
    ...
    description: 'Decentralized governance with voting power based on token holdings and participation.',
    icon: Users,
    ...
    <section className="py-24 bg-gradient-to-b from-black to-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          >
            Why Choose{' '}
            <span className="gradient-text">AGROTM</span>
          </motion.h2>
          ...
          >
            Experience the next generation of DeFi with cutting-edge features designed for maximum efficiency, 
        ...
        >
          <div className="bg-gradient-to-r from-primary-500/10 to-accent-500/10 border border-primary-500/20 rounded-2xl p-8">
            ...
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
              Join thousands of users who are already earning passive income with AGROTM's advanced DeFi protocols.
            </p>
