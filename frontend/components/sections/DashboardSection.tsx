          ...
          >
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <span className="text-gray-300 font-orbitron">Analytics em Tempo Real</span>
              </motion.div>
              <motion.div 
                initial={{ opacity: 0, x: -20 }}
                whileInView={{ opacity: 1, x: 0 }}
              ...
              >
                <div className="w-3 h-3 bg-[#00FF7F] rounded-full shadow-neon"></div>
                <span className="text-gray-300 font-orbitron">Métricas Avançadas</span>
              </motion.div>
              <motion.div 
                initial={{ opacity: 0, x: -20 }}
                whileInView={{ opacity: 1, x: 0 }}
              ...
              >
                <div className="w-3 h-3 bg-[#00FF7F] rounded-full shadow-neon"></div>
                <span className="text-gray-300 font-orbitron">Acompanhamento de Performance</span>
              </motion.div>
            </div>
          </motion.div>
