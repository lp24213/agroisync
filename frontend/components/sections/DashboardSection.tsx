  ...
  const features = [
    {
      ...
      description: 'Métricas em tempo real para tomada de decisões estratégicas'
    },
    {
      icon: <PieChart className="w-5 h-5" />,
      title: 'Relatórios Inteligentes',
      description: 'Dashboards personalizados com insights valiosos'
    },
    {
      icon: <Activity className="w-5 h-5" />,
      title: 'Monitoramento Contínuo',
      description: 'Acompanhamento 24/7 de todos os indicadores'
    },
    {
      icon: <TrendingUp className="w-5 h-5" />,
      title: 'Previsões Precisas',
      description: 'IA para otimização de resultados futuros'
    }
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-orbitron font-bold text-[#00bfff] mb-6">
              Dashboard <span className="text-[#00bfff]">Inteligente</span>
            </h2>
            
            <p className="text-lg text-[#00bfff] mb-8 max-w-2xl mx-auto lg:mx-0">
              Interface avançada de monitoramento e analytics em tempo real para gestão completa do agronegócio com tecnologia blockchain.
            </p>
          ...
          >
            <div className="relative h-80 lg:h-96 rounded-2xl overflow-hidden border border-[#00bfff]/20 shadow-neon-blue">
              <Image
                ...
                alt="Dashboard Inteligente - Interface de Monitoramento Avançado"
                fill
