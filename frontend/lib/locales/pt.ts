export default {
  ...
  auth: {
    createAccount: 'Criar Conta',
    joinAGROTM: 'Junte-se à revolução da agricultura digital',
    welcomeBack: 'Bem-vindo de volta',
    signInToAGROTM: 'Entre na sua conta AGROTM',
    ...
    metamaskDescription: 'Conecte sua carteira para acessar sua conta',
    connecting: 'Conectando...',
    ...
    phoneInvalid: 'Telefone deve estar no formato internacional (+5511999999999)',
    ...
    // Success messages
    registrationSuccess: 'Conta criada com sucesso! Verifique seu e-mail e telefone.',
    verificationSuccess: 'Conta verificada com sucesso!',
    verificationResent: 'Código reenviado com sucesso!',
    loginSuccess: 'Login realizado com sucesso!',
    metamaskLoginSuccess: 'Login com Metamask realizado com sucesso!',
    
    // Error messages
    registrationError: 'Erro ao criar conta',
    verificationError: 'Erro ao verificar conta',
    resendError: 'Erro ao reenviar código',
    loginError: 'Erro ao fazer login',
    metamaskLoginError: 'Erro ao fazer login com Metamask',
    networkError: 'Erro de rede. Tente novamente.',
    forgotPasswordNotImplemented: 'Recuperação de senha será implementada em breve',
    
    // Metamask specific
    metamaskNotInstalled: 'Metamask não está instalado. Instale a extensão primeiro.',
    metamaskNoAccounts: 'Nenhuma conta encontrada no Metamask',
    metamaskInfo: 'Sobre o Metamask',
    metamaskInfo1: 'Certifique-se de ter o Metamask instalado',
    metamaskInfo2: 'Conecte sua carteira Ethereum',
    metamaskInfo3: 'Aprove a assinatura para autenticação',
    
    // reCAPTCHA
    recaptchaNotice: 'Validação de segurança ativa',
  },
} as const;
