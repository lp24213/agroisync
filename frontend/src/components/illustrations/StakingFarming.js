  ...
  return (
    <svg viewBox='0 0 400 300' className={className}>
      ...
      <g transform='translate(100, 200)'>
        {/* Roots */}
        <path d='M 0 0 Q -10 10 -15 20 T -20 30' fill='none' stroke='#00d4ff' strokeWidth='2' filter='url(#glow)' />
        <path d='M 0 0 Q 10 10 15 20 T 20 30' fill='none' stroke='#00d4ff' strokeWidth='2' filter='url(#glow)' />
        <path d='M 0 0 Q -5 15 -8 25 T -10 35' fill='none' stroke='#00d4ff' strokeWidth='2' filter='url(#glow)' />
        <path d='M 0 0 Q 5 15 8 25 T 10 35' fill='none' stroke='#00d4ff' strokeWidth='2' filter='url(#glow)' />

        {/* Stem */}
        <line x1='0' y1='0' x2='0' y2='-30' stroke='#00d4ff' strokeWidth='3' filter='url(#glow)' />
        ...
        <ellipse
          ...
          filter='url(#glow)'
        />
        <ellipse cx='0' cy='-25' rx='5' ry='2.5' fill='none' stroke='#00d4ff' strokeWidth='2' filter='url(#glow)' />
      </g>

      {/* Center Plant (Largest) */}
      <g transform='translate(200, 200)'>
        {/* Roots */}
        <path d='M 0 0 Q -15 15 -25 30 T -35 45' fill='none' stroke='#00d4ff' strokeWidth='3' filter='url(#glow)' />
        <path d='M 0 0 Q 15 15 25 30 T 35 45' fill='none' stroke='#00d4ff' strokeWidth='3' filter='url(#glow)' />
        <path d='M 0 0 Q -8 20 -12 35 T -15 50' fill='none' stroke='#00d4ff' strokeWidth='2' filter='url(#glow)' />
        <path d='M 0 0 Q 8 20 12 35 T 15 50' fill='none' stroke='#00d4ff' strokeWidth='2' filter='url(#glow)' />

        {/* Stem */}
        <line x1='0' y1='0' x2='0' y2='-45' stroke='#00d4ff' strokeWidth='4' filter='url(#glow)' />
        ...
        <ellipse
          ...
          filter='url(#glow)'
        />
        <ellipse cx='0' cy='-40' rx='7' ry='3.5' fill='none' stroke='#00d4ff' strokeWidth='2' filter='url(#glow)' />
      </g>

      {/* Right Plant (Smallest) */}
      <g transform='translate(300, 200)'>
        {/* Roots */}
        <path d='M 0 0 Q -8 8 -12 15 T -15 22' fill='none' stroke='#00d4ff' strokeWidth='1.5' filter='url(#glow)' />
        <path d='M 0 0 Q 8 8 12 15 T 15 22' fill='none' stroke='#00d4ff' strokeWidth='1.5' filter='url(#glow)' />

        {/* Stem */}
        <line x1='0' y1='0' x2='0' y2='-20' stroke='#00d4ff' strokeWidth='2' filter='url(#glow)' />
        ...
        <ellipse
          ...
          filter='url(#glow)'
        />
        <ellipse cx='0' cy='-18' rx='3' ry='1.5' fill='none' stroke='#00d4ff' strokeWidth='1.5' filter='url(#glow)' />
      </g>

      {/* Circuit Board Ground */}
      <g transform='translate(0, 240)'>
        {/* Main Circuit Lines */}
        <path d='M 0 0 L 400 0' stroke='#00d4ff' strokeWidth='2' opacity='0.8' filter='url(#glow)' />
      ...
      <g opacity='0.3'>
        <path d='M 20 80 Q 60 60 100 80 T 180 80' fill='none' stroke='#00d4ff' strokeWidth='1' />
        <path d='M 220 80 Q 260 60 300 80 T 380 80' fill='none' stroke='#00d4ff' strokeWidth='1' />
        <path d='M 20 120 Q 60 100 100 120 T 180 120' fill='none' stroke='#00d4ff' strokeWidth='1' />
        <path d='M 220 120 Q 260 100 300 120 T 380 120' fill='none' stroke='#00d4ff' strokeWidth='1' />
      </g>
