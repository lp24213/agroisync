...
import { 
  ...
  Star, Package, Truck, MapPin, Calendar, DollarSign
} from 'lucide-react';
    ...
    return (
      <div className="space-y-8">
        <div className="card p-8 text-center">
          ...
          <h3 className="text-xl font-bold text-white mb-2">Carregando produtos...</h3>
    ...
    <div className="space-y-8">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-white/60 max-w-2xl mx-auto">
          Encontre os melhores produtos do agronegócio. 
          Qualidade garantida e entrega segura em todo o Brasil.
        </p>
      </div>
      ...
      <div className="card p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="text-center">
            <div className="text-3xl font-bold text-gradient-emerald mb-2">8.7K</div>
            <div className="text-white/60">Produtos Ativos</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-gradient-emerald mb-2">1.2K</div>
          ...
          <div className="text-center">
            <div className="text-3xl font-bold text-gradient-emerald mb-2">99.5%</div>
