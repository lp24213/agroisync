            ...
            <div className="glass-card p-8 mb-16">
              ...
              <div className="space-y-8">
                {roadmap.map((phase, index) => (
                  ...
                  >
                    <div className="flex flex-col lg:flex-row items-start lg:items-center space-y-4 lg:space-y-0 lg:space-x-6 p-6 bg-secondary/30 rounded-xl border border-border/30">
            ...
            <div className="glass-card p-8 mb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {technologies.map((tech, index) => (
                  ...
                  >
                    <div className="p-6 bg-secondary/30 rounded-xl border border-border/30 hover:border-primary/50 transition-all duration-300">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {features.map((feature, index) => (
                  <motion.div
                    ...
                    transition={{ duration: 0.5, delay: index * 0.1 }}
                  >
                    <div className="p-6 bg-secondary/30 rounded-xl border border-border/30 hover:border-primary/50 transition-all duration-300 group">
