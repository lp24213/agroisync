...
const AnimatedBackground = () => {
  ...
  return (
    <>
      ...
      <canvas ref={canvasRef} className='pointer-events-none fixed inset-0 z-0' style={{ background: 'transparent' }} />
      ...
      <div className='pointer-events-none fixed inset-0 z-0'>
        ...
        />
        <motion.div
          className='absolute bottom-1/4 right-1/4 h-80 w-80 rounded-full opacity-20'
          style={{
