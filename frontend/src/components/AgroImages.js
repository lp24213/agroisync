  ...
  return (
    <div className='space-y-12'>
      <div className='mb-8 text-center'>
        <h2 className='text-gradient-agro mb-4 text-3xl font-bold'>Galeria de Imagens AgroSync</h2>
      ...
      <div className='space-y-6'>
        <h3 className='text-center text-2xl font-bold text-white'>Logos e Identidade</h3>
            ...
            >
              <div className='card-premium overflow-hidden'>
                ...
                <div className='relative h-48 overflow-hidden'>
                  ...
                  />
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${getCategoryColor(image.category)} hidden items-center justify-center`}
                  >
                    <div className='text-center text-white'>
                      <div className='mb-2 text-4xl'>{getCategoryIcon(image.category)}</div>
                  ...
                  <div className='absolute inset-0 flex items-center justify-center bg-black/50 opacity-0 transition-opacity duration-300 group-hover:opacity-100'>
                    <div className='p-4 text-center text-white'>
                      <h3 className='mb-2 text-lg font-bold'>{image.title}</h3>
                ...
                <div className='p-4'>
                  <h3 className='mb-2 font-bold text-white transition-colors group-hover:text-emerald-400'>
                    {image.title}
                  </h3>
                  <p className='mb-3 line-clamp-2 text-sm text-white/60'>{image.description}</p>

                  {/* Tags */}
                  <div className='flex items-center justify-between'>
                    <span
                      className={`rounded-full bg-gradient-to-r px-2 py-1 text-xs font-medium ${getCategoryColor(image.category)} text-white`}
                    >
                      {image.category}
                    </span>
      ...
      <div className='space-y-6'>
        <h3 className='text-center text-2xl font-bold text-white'>Funcionalidades e Tecnologia</h3>
      ...
      <div className='card-premium p-8'>
        <h3 className='mb-6 text-center text-2xl font-bold text-white'>Como Usar Estas Imagens</h3>
