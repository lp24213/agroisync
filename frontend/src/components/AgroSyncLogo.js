  ...
  if (variant === "text") {
    return (
      <div className={`flex items-center space-x-3 ${className}`}>
        <AgroSyncIcon className="w-8 h-8" />
  ...
  if (variant === "full") {
    return (
      <div className={`flex items-center space-x-4 ${className}`}>
        <AgroSyncIcon className="w-12 h-12" />
...
const AgroSyncIcon = ({ className }) => (
  ...
  >
    ...
    <g transform="translate(16, 12)">
      ...
      {/* Folhas */}
      <path
        d="M16 12 Q8 8 8 16 Q8 20 12 18 Q16 20 20 18 Q24 20 24 16 Q24 8 16 12"
        fill="white"
        opacity="0.9"
      />
      ...
      {/* Folha direita */}
      <path
        d="M16 16 Q24 12 24 20 Q24 24 20 22 Q16 24 12 22 Q8 24 8 20 Q8 12 16 16"
        fill="white"
        opacity="0.7"
      />
      ...
      {/* Folha esquerda */}
      <path
        d="M16 20 Q8 16 8 24 Q8 28 12 26 Q16 28 20 26 Q24 28 24 24 Q24 16 16 20"
        fill="white"
        opacity="0.5"
      />
    </g>
