...
import { Switch, Loader2, CheckCircle, Clock, AlertCircle, DollarSign, Zap, ExternalLink } from 'lucide-react'
    ...
    >
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center">
          <Switch className="w-6 h-6 mr-2 text-agro-emerald" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
          <div className="flex items-center justify-between">
            ...
            <Switch className="w-8 h-8 text-gray-400" />
          </div>
        </div>
      ...
      {switches.length === 0 ? (
        <div className="text-center py-8">
          <Switch className="w-16 h-16 text-gray-400 mx-auto mb-4" />
