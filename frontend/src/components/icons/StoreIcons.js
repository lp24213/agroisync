...
export const SoyIcon = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2C8 2 5 5 5 9C5 11 6 13 7.5 14.5C8.5 15.5 10 16 11.5 16.5C11.7 16.6 11.9 16.7 12 16.8C12.1 16.7 12.3 16.6 12.5 16.5C14 16 15.5 15.5 16.5 14.5C18 13 19 11 19 9C19 5 16 2 12 2Z" fill={color} stroke={color} strokeWidth="1.5"/>
    ...
    <path d="M12 10C12.5 10 13 10.5 13 11C13 11.5 12.5 12 12 12C11.5 12 11 11.5 11 11C11 10.5 11.5 10 12 10Z" fill="white"/>
    <path d="M8 18C9 18 10 18.5 11 19C11.3 19.2 11.7 19.2 12 19.2C12.3 19.2 12.7 19.2 13 19C14 18.5 15 18 16 18" stroke={color} strokeWidth="1.5" strokeLinecap="round"/>
    <path d="M6 20C7.5 20 9 20.5 10.5 21C11.2 21.3 12.8 21.3 13.5 21C15 20.5 16.5 20 18 20" stroke={color} strokeWidth="1.5" strokeLinecap="round"/>
  </svg>
);
...
export const CornIcon = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 3C10 3 8.5 4.5 8.5 6.5V17.5C8.5 19.5 10 21 12 21C14 21 15.5 19.5 15.5 17.5V6.5C15.5 4.5 14 3 12 3Z" fill={color} stroke={color} strokeWidth="1.5"/>
...
export const CoffeeIcon = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M6 12C6 10 7 9 8 9H16C17 9 18 10 18 12V16C18 18 16 20 14 20H10C8 20 6 18 6 16V12Z" fill={color} stroke={color} strokeWidth="1.5"/>
...
export const VegetableIcon = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M12 3C12 3 10 4 9 6C8 8 9 10 12 10C15 10 16 8 15 6C14 4 12 3 12 3Z" fill={color} stroke={color} strokeWidth="1"/>
  </svg>
);
...
export const FruitIcon = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M12 6C12 6 11 5 10 6C9 7 10 8 12 8C14 8 15 7 14 6C13 5 12 6 12 6Z" fill={color} stroke={color} strokeWidth="1"/>
...
export const DairyIcon = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M7 6H17C18 6 19 7 19 8V18C19 20 17 22 15 22H9C7 22 5 20 5 18V8C5 7 6 6 7 6Z" fill={color} stroke={color} strokeWidth="1.5"/>
...
export const MeatIcon = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M6 8C6 6 8 4 12 4C16 4 18 6 18 8C18 10 16 12 12 12C8 12 6 10 6 8Z" fill={color} stroke={color} strokeWidth="1.5"/>
...
export const SeedIcon = ({ className = "w-6 h-6", color = "currentColor" }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M12 9C12 9 10 7 8 9C6 11 8 13 12 13C16 13 18 11 16 9C14 7 12 9 12 9Z" fill={color} stroke={color} strokeWidth="1"/>
    <path d="M12 15C12 15 10 17 8 15C6 13 8 11 12 11C16 11 18 13 16 15C14 17 12 15 12 15Z" fill={color} stroke={color} strokeWidth="1"/>
    <path d="M9 12C9 12 7 10 9 8C11 6 13 8 13 12C13 16 11 18 9 16C7 14 9 12 9 12Z" fill={color} stroke={color} strokeWidth="1"/>
    <path d="M15 12C15 12 17 10 15 8C13 6 11 8 11 12C11 16 13 18 15 16C17 14 15 12 15 12Z" fill={color} stroke={color} strokeWidth="1"/>
