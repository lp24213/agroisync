    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className='fixed bottom-6 right-6 z-50 h-96 w-80'
        >
          {/* Container principal do chat */}
          <div
            className={`h-full w-full overflow-hidden rounded-2xl border shadow-2xl backdrop-blur-md ${
              isDark ? 'border-gray-700 bg-gray-900/95' : 'border-gray-200 bg-white/95'
            }`}
          >
            {/* Header do chat */}
            <div className={`border-b p-3 ${isDark ? 'border-gray-700 bg-gray-800' : 'border-gray-200 bg-gray-100'}`}>
              <div className='flex items-center justify-between'>
                <div className='flex items-center space-x-2'>
                  <div
                    className={`h-8 w-8 rounded-full bg-gradient-to-r ${personalities[chatbotPersonality].color} flex items-center justify-center text-sm font-bold text-white`}
                  >
                ...
                <div className='flex items-center space-x-1'>
                  ...
                  <select
                    ...
                    className={`rounded p-1 text-xs transition-colors ${
                      isDark ? 'border-gray-600 bg-gray-700 text-gray-300' : 'border-gray-300 bg-gray-200 text-gray-600'
                    }`}
                  >
            ...
            {showPersonalitySelector && (
              <motion.div
                ...
                className={`border-b p-3 ${isDark ? 'border-gray-700 bg-gray-800' : 'border-gray-200 bg-gray-100'}`}
              >
                <p className={`mb-2 text-xs ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                      ...
                      className={`rounded p-2 text-xs transition-all ${
                        chatbotPersonality === key
                          ? isDark
                            ...
                            : 'border border-green-500 bg-green-500/20 text-green-600'
                          : isDark
                            ? 'bg-gray-700 text-gray-300 hover:bg-gray-600'
                            : 'bg-gray-200 text-gray-600 hover:bg-gray-300'
                      }`}
                    >
                      <div className='mb-1 text-lg'>{personality.avatar}</div>
                    ...
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className='flex justify-start'>
                      ...
                      >
                        <div className='flex items-center space-x-1'>
                          ...
                          <span className='ml-2 text-xs'>Digitando...</span>
                        </div>
                      </div>
                    </motion.div>
                  )}
                ...
                <div className={`border-t p-3 ${isDark ? 'border-gray-700' : 'border-gray-200'}`}>
                  <div className='flex items-center space-x-2'>
                    ...
                    <input
                      ...
                      className={`flex-1 rounded-lg border p-2 transition-colors duration-200 ${
                        isDark
                          ? 'border-gray-600 bg-gray-800 text-white placeholder-gray-400 focus:border-cyan-400'
                          : 'border-gray-300 bg-gray-100 text-gray-900 placeholder-gray-500 focus:border-green-500'
                      }`}
                    />
