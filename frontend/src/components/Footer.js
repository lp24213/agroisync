            ...
            >
              <div className="flex items-center space-x-2 mb-4">
                <div className="flex items-center justify-center shadow-lg w-10 h-10">
                  <img src="/logo-agroisync.svg" alt="AGROISYNC" className="w-8 h-8" />
                </div>
                <span className="text-xl font-bold text-agro-text-primary">AGROISYNC</span>
              </div>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className="text-agro-text-secondary">(66) 99236-2830</span>
            </div>
            <div className="flex items-center space-x-3">
