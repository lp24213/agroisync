      ...
      <div className='container mx-auto px-4 py-8'>
        <div className='mx-auto max-w-4xl'>
          ...
          <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className='mb-8 text-center'>
            ...
            <h1 className='mb-2 text-3xl font-bold text-gray-900'>Cadastro de Transportador</h1>
            <p className='text-gray-600'>Preencha todos os dados para se cadastrar como transportador</p>
          </motion.div>
                ...
                return (
                  <div key={step.number} className='flex flex-1 flex-col items-center'>
                    ...
                    {index < steps.length - 1 && (
                      <div className={`mt-4 h-1 w-full ${isCompleted ? 'bg-green-500' : 'bg-gray-200'}`} />
                    )}
                  </div>
                );
              })}
          ...
          >
            <form onSubmit={handleSubmit}>
              ...
              {currentStep === 2 && (
                <div className='space-y-6'>
                  <h2 className='mb-6 text-2xl font-bold text-gray-900'>Dados da Empresa</h2>

                  <div className='grid grid-cols-1 gap-6 md:grid-cols-2'>
                    <div className='md:col-span-2'>
                      <label className='mb-2 block text-sm font-medium text-gray-700'>Nome da Empresa *</label>
                      <input
                        type='text'
                        name='companyName'
                    ...
                    <div>
                      <label className='mb-2 block text-sm font-medium text-gray-700'>Inscrição Estadual *</label>
                      <input
                        type='text'
                        name='ie'
                        value={formData.ie}
                      ...
                      />
                      {errors.ie && <p className='mt-1 text-sm text-red-500'>{errors.ie}</p>}
                    </div>
                  </div>
                </div>
              )}
              ...
              {currentStep === 3 && (
                <div className='space-y-6'>
                  <h2 className='mb-6 text-2xl font-bold text-gray-900'>Dados do Veículo</h2>

                  <div className='grid grid-cols-1 gap-6 md:grid-cols-2'>
                    <div>
                      <label className='mb-2 block text-sm font-medium text-gray-700'>Tipo de Veículo *</label>
                      <select
                        name='vehicleType'
                    ...
                    <div>
                      <label className='mb-2 block text-sm font-medium text-gray-700'>Placa *</label>
                      <input
                        type='text'
                        name='licensePlate'
                    ...
                    <div>
                      ...
                      <input
                        ...
                        max='2024'
                      />
                      {errors.vehicleYear && <p className='mt-1 text-sm text-red-500'>{errors.vehicleYear}</p>}
                    </div>

                    <div className='md:col-span-2'>
                      <label className='mb-2 block text-sm font-medium text-gray-700'>Capacidade (kg) *</label>
                      <input
                        type='number'
                        name='capacity'
              ...
              {currentStep === 4 && (
                <div className='space-y-6'>
                  <h2 className='mb-6 text-2xl font-bold text-gray-900'>Dados do Motorista</h2>

                  <div className='grid grid-cols-1 gap-6 md:grid-cols-2'>
                    <div className='md:col-span-2'>
                      <label className='mb-2 block text-sm font-medium text-gray-700'>Nome do Motorista *</label>
                      <input
                        type='text'
                        name='driverName'
                    ...
                    <div>
                      <label className='mb-2 block text-sm font-medium text-gray-700'>CPF do Motorista *</label>
                      <input
                        type='text'
                        name='driverCpf'
                        ...
                        placeholder='000.000.000-00'
                      />
                      {errors.driverCpf && <p className='mt-1 text-sm text-red-500'>{errors.driverCpf}</p>}
                    </div>

                    <div>
                      <label className='mb-2 block text-sm font-medium text-gray-700'>Telefone do Motorista *</label>
                      <input
                        type='tel'
                        name='driverPhone'
                    ...
                    <div>
                      <label className='mb-2 block text-sm font-medium text-gray-700'>CNH *</label>
                      <input
                        type='text'
                        name='driverLicense'
                      ...
                      />
                      {errors.driverLicense && <p className='mt-1 text-sm text-red-500'>{errors.driverLicense}</p>}
                    </div>

                    <div>
                      <label className='mb-2 block text-sm font-medium text-gray-700'>Categoria da CNH *</label>
                      <select
                      ...
                      {errors.driverLicenseCategory && (
                        <p className='mt-1 text-sm text-red-500'>{errors.driverLicenseCategory}</p>
                      )}
                    </div>
                  </div>
                </div>
              ...
              {currentStep === 5 && (
                <div className='space-y-6'>
                  <h2 className='mb-6 text-2xl font-bold text-gray-900'>Endereço</h2>
                  ...
                  <div className='grid grid-cols-1 gap-6 md:grid-cols-2'>
                    ...
                    <div className='md:col-span-2'>
                      <label className='mb-2 block text-sm font-medium text-gray-700'>Rua *</label>
                      <input
                        type='text'
                        name='street'
                    ...
                    <div>
                      <label className='mb-2 block text-sm font-medium text-gray-700'>Complemento</label>
                      <input
                        type='text'
                        name='complement'
              ...
              {currentStep === 6 && (
                <div className='space-y-6'>
                  <h2 className='mb-6 text-2xl font-bold text-gray-900'>Dados Bancários e Documentos</h2>

                  <div className='grid grid-cols-1 gap-6 md:grid-cols-2'>
                    <div>
                      <label className='mb-2 block text-sm font-medium text-gray-700'>Nome do Banco *</label>
                      <input
                        type='text'
                        name='bankName'
                    ...
                    <div>
                      <label className='mb-2 block text-sm font-medium text-gray-700'>Agência *</label>
                      <input
                        type='text'
                        name='agency'
                    ...
                    <div>
                      <label className='mb-2 block text-sm font-medium text-gray-700'>Conta *</label>
                      <input
                        type='text'
                        name='account'
                    ...
                    <div>
                      <label className='mb-2 block text-sm font-medium text-gray-700'>Tipo de Conta</label>
                      <select
                        name='accountType'
                    ...
                    <div className='md:col-span-2'>
                      <div className='flex items-center space-x-4'>
                        ...
                        />
                        <label className='text-sm font-medium text-gray-700'>Possui registro ANTT</label>
                      </div>
                    </div>

                    {formData.hasAntt && (
                      <div>
                        <label className='mb-2 block text-sm font-medium text-gray-700'>Número ANTT</label>
                        <input
                          type='text'
                          name='anttNumber'
                    ...
                    <div className='md:col-span-2'>
                      <div className='flex items-center space-x-4'>
                        <input
                          ...
                          className='h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500'
                        />
                        <label className='text-sm font-medium text-gray-700'>Possui seguro</label>
                      </div>
                    </div>
                    ...
                    {formData.hasInsurance && (
                      <>
                        <div>
                          <label className='mb-2 block text-sm font-medium text-gray-700'>Seguradora</label>
                          <input
                            type='text'
                        ...
                        <div>
                          <label className='mb-2 block text-sm font-medium text-gray-700'>Número da Apólice</label>
                          <input
                            type='text'
              ...
              {currentStep === 7 && (
                <div className='space-y-6'>
                  <h2 className='mb-6 text-2xl font-bold text-gray-900'>Criar Senha</h2>
              ...
              <div className='mt-8 flex justify-between'>
                ...
                {currentStep < 7 ? (
                  ...
                  <button
                    type='submit'
                    disabled={isLoading}
                    className={`flex items-center gap-2 rounded-lg px-8 py-3 font-medium transition-colors ${
                      isLoading
