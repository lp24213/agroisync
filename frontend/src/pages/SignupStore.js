...
import { User, Mail, Lock, Eye, EyeOff, ArrowRight, Building2, MapPin, Phone, CreditCard, Truck, CheckCircle, AlertCircle } from 'lucide-react';
        ...
        <div className="w-full max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              className="bg-white/90 backdrop-blur-xl border border-white/30 rounded-3xl shadow-2xl shadow-blue-500/20 p-8"
            >
              <motion.div
                variants={itemVariants}
              ...
              >
                ...
                <div style={{
                  ...
                  <p style={{ fontSize: '0.9rem', opacity: 0.8 }}>
                    Ideal para lojas como a Agrobiológica
                  </p>
                </div>
              </motion.div>
              ...
              <form onSubmit={handleSubmit}>
                ...
                >
                  ...
                  <div style={{ position: 'relative' }}>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-4 pl-12 bg-gray-50/80 border-2 rounded-2xl text-gray-900 placeholder-gray-500 
                        transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 
                        hover:bg-gray-100/80 ${errors.name ? 'border-red-300 focus:border-red-500 focus:ring-red-500/20' : 'border-gray-200'}`}
                      onFocus={(e) => {
                    ...
                    <div>
                      ...
                      <input
                        ...
                        style={{
                          ...
                          borderRadius: '12px', fontSize: '1rem', background: 'rgba(248, 250, 252, 0.8)', transition: 'all 0.3s ease', outline: 'none'
                        }}
                      />
                    </div>
                    <div>
                ...
                {/* SEÇÃO PRODUTOS */}
                <motion.div variants={itemVariants} style={{ marginBottom: '2rem' }}>
                  <h3 style={{ color: 'var(--text-primary)', marginBottom: '1rem', fontSize: '1.2rem', fontWeight: '600' }}>🛍️ Produtos</h3>
                  ...
                  <div style={{ marginBottom: '1rem' }}>
                    ...
                    <textarea
                      ...
                      style={{
                        ...
                        borderRadius: '12px', fontSize: '1rem', background: 'rgba(248, 250, 252, 0.8)', transition: 'all 0.3s ease', outline: 'none', resize: 'vertical'
                      }}
                    />
                  </div>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '1rem', marginBottom: '1rem' }}>
                    ...
                    <div>
                      <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '600', color: 'var(--text-primary)' }}>Estoque (kg) *</label>
                      <input
                        type="number"
                        name="productStock"
                        ...
                        placeholder="1000"
                        style={{
                          width: '100%', padding: '12px', border: `2px solid ${errors.productStock ? '#dc2626' : 'rgba(15, 15, 15, 0.1)'}`,
                          borderRadius: '12px', fontSize: '1rem', background: 'rgba(248, 250, 252, 0.8)', transition: 'all 0.3s ease', outline: 'none'
                        }}
                      />
                    </div>
