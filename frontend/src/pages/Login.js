        ...
        <div className="card-futuristic p-8">
          <div className="text-center mb-8">
            <motion.div
              ...
              className="w-16 h-16 mx-auto mb-4 bg-gradient-to-r from-neon-blue to-neon-purple rounded-xl flex items-center justify-center"
            >
            ...
            <p className="text-gray-400">
              Faça login na sua conta AgroSync
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-10 input-futuristic"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="w-full pl-10 pr-10 input-futuristic"
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input
                  type="checkbox"
                  className="w-4 h-4 text-neon-blue bg-transparent border-gray-600 rounded focus:ring-neon-blue focus:ring-2"
                />
