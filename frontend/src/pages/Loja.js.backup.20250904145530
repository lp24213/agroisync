...
const Loja = () => {
      ...
      <div className="min-h-screen bg-black text-white p-8">
        <div className="max-w-7xl mx-auto">
          <div className="card p-8 text-center">
            ...
            <p className="text-gray-400">Aguarde enquanto carregamos os produtos disponíveis.</p>
          </div>
        </div>
      </div>
    );
  ...
  if (loading) {
    ...
    return (
      <div className="min-h-screen bg-agro-bg-primary flex items-center justify-center">
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          className="text-center"
        >
          <div className="animate-spin rounded-full h-16 w-16 border-b-2 border-agro-accent-emerald mx-auto mb-4"></div>
          <p className="text-agro-text-secondary">Carregando marketplace...</p>
        </motion.div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-agro-bg-primary text-agro-text-primary py-8 pt-16">
      {/* Header com Filtros */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-agro-text-secondary">
        ...
        <motion.nav
          ...
          className="mb-8"
        >
          <div className="border-b border-agro-border-primary">
                ...
                return (
                  <button
                    ...
                    className={`flex items-center space-x-2 py-4 px-1 border-b-2 font-medium text-sm transition-colors ${
                      activeTab === tab.id
                        ? 'border-agro-accent-emerald text-agro-accent-emerald'
                        : 'border-transparent text-agro-text-tertiary hover:text-agro-text-primary hover:border-agro-border-primary'
                    }`}
                  >
                    <Icon className="w-4 h-4" />
                    <span>{tab.name}</span>
                    {tab.count > 0 && (
                      <span className="bg-agro-accent-emerald text-agro-text-primary text-xs rounded-full px-2 py-1">
                        {tab.count}
                      </span>
                    )}
                  </button>
