      ...
      <div className="min-h-screen bg-white text-gray-900 pt-16">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="card p-8 text-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Carregando dados de criptomoedas...</h3>
            <p className="text-gray-600">Aguarde enquanto carregamos os dados em tempo real.</p>
          </div>
        </div>
      </div>
    );
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
              <div className="card p-6 text-center">
                ...
                <div className="text-gray-600">Market Cap Total</div>
              </div>
              <div className="card p-6 text-center">
              ...
              <div className="card p-6 text-center">
                ...
                <div className="text-gray-600">Criptomoedas</div>
              </div>
              <div className="card p-6 text-center">
                <div className="text-3xl font-bold text-gradient-emerald mb-2">51.2%</div>
                <div className="text-gray-600">Dominância BTC</div>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
            <div className="flex items-center space-x-4">
              <h2 className="text-2xl font-bold text-gray-900">Top Criptomoedas</h2>
              <motion.button
