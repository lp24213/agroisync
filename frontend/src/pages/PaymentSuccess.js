...
const PaymentSuccess = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-agro-bg-primary text-agro-text-primary flex items-center justify-center pt-16">
        <div className="text-center">
          <div className="animate-spin rounded-full h-16 w-16 border-b-2 border-agro-accent-emerald mx-auto mb-4"></div>
          <p className="text-agro-text-secondary">Verificando pagamento...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-agro-bg-primary text-agro-text-primary pt-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            ...
            <p className="text-lg text-agro-text-secondary mb-8">
