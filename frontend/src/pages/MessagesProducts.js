...
const MessagesProducts = () => {
  ...
  // Verificar se o usuário tem plano ativo para produtos
  useEffect(() => {
    const checkPlanAccess = async () => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          const storePlan = userData.subscriptions?.store;
  ...
  useEffect(() => {
    ...
    const loadConversations = async () => {
      try {
        setLoading(true);
        const response = await messagingService.getConversations('product');
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-2xl p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Para acessar a mensageria de produtos, você precisa ter um plano ativo da Loja.
          </p>
          
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            <h3 className="font-semibold text-blue-900 mb-2">Plano Loja - R$25/mês</h3>
            <ul className="text-sm text-blue-800 space-y-1">
              <li>• Até 3 anúncios de produtos</li>
              <li>• Mensageria privada com compradores</li>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Mensageria de Produtos</h1>
                <p className="text-sm text-gray-500">Gerencie suas conversas de vendas</p>
              </div>
            </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-yellow-700 mt-1">
                <strong>NUNCA faça pagamentos sem confirmar a veracidade do produto.</strong> 
                A Agroisync não se responsabiliza por pagamentos ou negociações externas. 
                Todas as transações são de responsabilidade do comprador e vendedor.
              </p>
            </div>
          </div>
        </div>
...
export default MessagesProducts;
