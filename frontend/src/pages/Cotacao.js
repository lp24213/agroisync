        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-white rounded-lg shadow-lg border border-gray-200">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-900">1. {t('cotacao.detectionStep1')}</h3>
              <p className="text-gray-600">{t('cotacao.detectionStep1Desc')}</p>
            </div>
            ...
            <div className="text-center p-6 bg-white rounded-lg shadow-lg border border-gray-200">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-900">2. {t('cotacao.detectionStep2')}</h3>
              <p className="text-gray-600">{t('cotacao.detectionStep2Desc')}</p>
            </div>
            ...
            <div className="text-center p-6 bg-white rounded-lg shadow-lg border border-gray-200">
              ...
              <h3 className="text-xl font-semibold mb-2 text-gray-900">3. {t('cotacao.detectionStep3')}</h3>
              <p className="text-gray-600">{t('cotacao.detectionStep3Desc')}</p>
            </div>
          </div>
        </div>
      </section>
