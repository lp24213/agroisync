...
describe('Security Tests', () => {
  ...
  describe('XSS Protection', () => {
    ...
    it('should validate password strength', () => {
      const weakPasswords = ['123456', 'password', 'qwerty', 'abc123', 'admin'];

      const strongPasswords = ['StrongPass123!', 'MySecure@Pass2024', 'Complex#Password1'];
      ...
      const TestComponent = () => {
        ...
        return (
          <div>
            ...
            {step === 'processing' && <div data-testid='processing'>Processing payment...</div>}

            {step === 'success' && <div data-testid='success'>Payment successful!</div>}

            {step === 'error' && <div data-testid='error'>Payment failed</div>}
          </div>
        );
      };
