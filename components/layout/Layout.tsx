...
const Layout: React.FC<LayoutProps> = ({ children }) => (
  <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-900">
    ...
    <footer className="w-full p-4 bg-gray-200 dark:bg-gray-800 text-center text-xs text-gray-500">
      &copy; {new Date().getFullYear()} AGROTM. Todos os direitos reservados.
    </footer>
  </div>
);
