...
export function NeonButton({
  ...
  const baseClasses =
    'relative inline-flex items-center justify-center font-medium rounded-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-neon-blue/50 disabled:opacity-50 disabled:cursor-not-allowed';

  const variants = {
    primary:
      'bg-neon-blue text-matte-black hover:bg-neon-blue-dark shadow-neon hover:shadow-neon-strong',
