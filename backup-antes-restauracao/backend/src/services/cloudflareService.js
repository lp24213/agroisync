...
class CloudflareService {
  constructor() {
    // Usar as variáveis definidas no wrangler.toml
    this.turnstileSecret = process.env.CF_TURNSTILE_SECRET_KEY;
    this.siteKey = process.env.CF_TURNSTILE_SITE_KEY;
    this.turnstileEnabled = process.env.CF_TURNSTILE_ENABLED === 'true';
  ...
  async verifyTurnstileToken(token, remoteip = null) {
    try {
      ...
      // Build form-encoded payload (Cloudflare expects application/x-www-form-urlencoded)
      const params = new URLSearchParams();
      params.append('secret', this.turnstileSecret);
