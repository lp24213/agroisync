...
Backend completo da plataforma AgroSync - Sistema de agronegócio com
marketplace, fretes, pagamentos e mensageria privada.
...
OPENWEATHER_API_KEY=sua_chave_openweather RECEITA_WS_API_KEY=sua_chave_receita
