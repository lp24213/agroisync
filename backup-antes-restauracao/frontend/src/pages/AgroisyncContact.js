...
const AgroisyncContact = () => {
  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--bloomfi-bg-secondary)' }}>
      {/* Hero Section */}
            ...
            >
              ...
              {contactInfo.map((item, index) => (
                <motion.a
                  ...
                  className="bloomfi-card"
                >
                  <div className="flex items-start gap-4">
                    <div className="bloomfi-feature-icon" style={{ width: '48px', height: '48px', margin: 0 }}>
                      <item.icon size={24} />
                    </div>
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="bloomfi-btn bloomfi-btn-primary w-full disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
                    <>
