...
(function () {
  ...
  function updateNavbar() {
    ...
    if (currentScrollY > 100) {
      if (navbar && navbar.classList && typeof navbar.classList.add === 'function') navbar.classList.add('navbar-scrolled');
    } else {
      if (navbar.classList) navbar.classList.remove('navbar-scrolled');
    }
  ...
  function initLanguageSelector() {
    const languageBtn = document.querySelector('.agroisync-language-btn');
    const languageDropdown = document.querySelector('.agroisync-language-dropdown');
    ...
    const languageOptions = languageDropdown.querySelectorAll('.agroisync-lang-option');
    languageOptions.forEach(option => {
      option.addEventListener('click', e => {
        ...
        // Update active state
        languageOptions.forEach(opt => opt.classList && opt.classList.remove('active'));
        if (option && option.classList && typeof option.classList.add === 'function') option.classList.add('active');
  ...
  function initMobileMenu() {
    const mobileMenuBtn = document.querySelector('.agroisync-mobile-menu-btn');
    const mobileMenu = document.querySelector('.agroisync-mobile-menu');
