...
export default function WhitelistForm() {
  ...
  return (
    <form
      ...
      className="p-6 bg-blue-950 rounded-xl text-white space-y-4 max-w-md"
    >
      ...
      <input
        ...
        required
        className="p-2 w-full rounded bg-black border border-blue-800"
      />
      <input
        value={wallet}
        onChange={(e) => setWallet(e.target.value)}
        placeholder="Sua carteira MetaMask"
        required
        className="p-2 w-full rounded bg-black border border-blue-800"
      />
      <button className="px-4 py-2 rounded bg-blue-700 hover:bg-blue-800 text-white font-semibold">
        Registrar
      </button>
